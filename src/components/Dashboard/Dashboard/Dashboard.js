    ...
    return (
        <Container>
            ...
            <Table striped bordered hover>
                ...
                <tbody>
                    {
                        launches?.length === 0 && <div className="d-flex justify-content-center"><CircularProgress /></div>
                    }


                    {
                        launches?.map(launch => <DashboardTableData launch={launch}></DashboardTableData>)
                    }
